package com.ziroom.kotlindemo.chapter7.anli_digui

/**
 *Author:关震
 *Date:2021/3/25 17:41
 *Description:Digui 递归列表
 **/
...
fun intListOf(vararg ints: Int): IntList {
    return when(ints.size) {
        0 -> IntList.Nil
            ...
            IntList.Cons(
                ints[0],
                intListOf(*(ints.slice(1 until ints.size).toIntArray()))  //递归
            )
        }
    }
}
...
//    val (a, b, c, d, e) = listOf<Int>() //解构  最多5个
}